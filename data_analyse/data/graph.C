...
void loadings()
{
    ...
    int nBinsX = 100;
    TH1D *h1 = new TH1D("Loadings Stat", "Loadings distribution", nBinsX, 0, 40);
    ...
    TCanvas *c1 = new TCanvas("c1", "Loadings", 2426, 1433);
    c1->SetRightMargin(0.18);
    c1->SetGrid();
    // gStyle->SetOptStat(0);
    h1->Draw();
    ...
    h1->GetXaxis()->SetTitle("Loadings, MHz");
