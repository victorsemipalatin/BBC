...
start_file = os.path.join("data", "output_09.05.2025_22:44:44.root")
file = ROOT.TFile(start_file)
file_up = uproot.open(start_file)
keys =  file_up.keys()
type_of_stand = "_gamma"
folders = ("model_test")
for key in keys:
    print(key)
    h1 = file.Get(key)
    ...
    for f in os.listdir(path_to_data):
        if os.path.join(path_to_data, f) != start_file and "output" in f and "09.05" in f  and f not in folders:
